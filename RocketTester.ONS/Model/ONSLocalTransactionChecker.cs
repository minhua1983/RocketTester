        ...
        public override TransactionStatus check(Message value)
        {
            ...
            try
            {
                ...
                if (ONSHelper.CheckerMethodDictionary.ContainsKey(value.getUserProperties("checkerMethod")))
                {
                    ...
                    string checkerMethodParameter = value.getUserProperties("checkerMethodParameter");
                    ...
                    {
                        //string类型
                        serviceResult = (ServiceResult)methodInfo.Invoke(service, new object[] { checkerMethodParameter });
                    }
                    else
                    {
                        //自定义类型
                    ...
                    LogHelper.Log("MESSAGE_KEY:" + value.getKey() + ",ONSLocalTransactionChecker.check.data:" + serviceResult.Data);
                    LogHelper.Log("MESSAGE_KEY:" + value.getKey() + ",ONSLocalTransactionChecker.check.message:" + serviceResult.Message);
                    LogHelper.Log("MESSAGE_KEY:" + value.getKey() + ",ONSLocalTransactionChecker.check.pushable:" + serviceResult.Pushable);
                ...
                else
                {
                    ...
                    LogHelper.Log("MESSAGE_KEY:" + value.getKey() + ",ONSLocalTransactionChecker.check.error:CheckerFuncDictionary中不存在key:" + value.getUserProperties("checkerMethod"));
                }
            }
            catch (Exception e)
            {
            ...
            try
            {
                if (RT != null)
                {
                    ...
                    produceData.TransactionType = "Checker";
